...
from .views import add_project, approve_to_work, deny_to_work, homepage, initiate_work, register_interest, show_profile, view_projects, view_project, view_tag_industry, update_project, view_tag_company, view_tag_location
